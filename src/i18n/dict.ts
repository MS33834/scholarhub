...
const zh: Dict = {
  ...
  'about.data.body':
    '资源目录用 TypeScript 写在 src/data/ 里。每条记录包含标题、作者、年份、类型、摘要、链接、标签，还有 APA、MLA、GB/T 7714、BibTeX 四种引用格式。',
  'about.contribute.title': '参与贡献',
  'about.contribute.body':
    '发现链接失效或缺少资源？提交个 issue 最快。想添加新资源？直接改 src/data/resources.ts 然后提 PR。',
