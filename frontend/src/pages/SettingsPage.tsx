          ...
          return (
            <li key={o.value}>
              <button
                ...
                className="w-full flex items-center gap-4 py-5 text-left group transition-colors duration-200 px-3 -mx-3"
                aria-pressed={active}
              >
                <span
                ...
                <span className={`text-mono text-[11px] uppercase tracking-wider2 transition-all duration-200 px-3 py-1 border rounded-[2px] ${
                  active ? 'text-moss border-moss opacity-100' : 'text-ink-mute border-transparent opacity-0'
                }`}>
                  {selectedLabel}
                </span>
              </button>
  ...
  return (
    <div className="page-fade mx-auto max-w-column px-6 sm:px-8 pt-16 pb-32">
      <header className="border-b border-rule pb-10">
        ...
        <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl text-ink tracking-tight">{t('settings.title')}</h1>
