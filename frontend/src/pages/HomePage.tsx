  ...
  return (
    <div className="page-fade">
      ...
      <main id="main-content">
        ...
        <section className="mx-auto max-w-column px-6 sm:px-8 pt-24 pb-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex items-center justify-center gap-3" aria-hidden="true">
              ...
              <span className="w-1.5 h-1.5 rotate-45 bg-moss/60" />
              <span className="h-px w-10 bg-rule" />
            </div>
        ...
        {/* 精选资源 - 横向滚动列 */}
        <section className="mx-auto max-w-column px-6 sm:px-8 my-28">
          ...
          <div className="-mx-6 sm:-mx-8 overflow-x-auto pb-6 pt-2">
          ...
          <p className="mt-4 text-mono text-[10px] uppercase tracking-wider2 text-ink-soft text-right">
